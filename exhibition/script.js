...
for (let i = 0; i < savebtn.length; i++) {
  savebtn[i].onclick = function toggle() {
    if (icon[i].classList.contains("fa-regular")) {
      icon[i].classList.replace("fa-regular", "fa");
    } else {
      icon[i].classList.replace("fa", "fa-regular");
    }
  };
}
...
/*for (let i = 0; i < savebtn.length; i++) {
  savebtn[i].onclick = function toggle() {
    for (let j = 0; j < icon.length; j++) {
      if (icon[j].classList.contains("fa-regular")) {
        icon[j].classList.replace("fa-regular", "fa");
      } else {
        icon[j].classList.replace("fa", "fa-regular");
      }
    }
  };
}*/
